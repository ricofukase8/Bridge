    ...
    <!-- <form action="/action_page.php"> -->
      <div class="row">
        <div class="col-25">
          ...
          <p id="message">名前を入力してください</p>
        </div>
        <div class="col-75">
        <input type="text" id="name" name="input_name" placeholder="Your name.." value="<?php echo isset($signin_user) ? $signin_user["name"] : ''; ?>" required="required"> 
        </div>
      </div>
      <div class="row">
        <div class="col-25">
