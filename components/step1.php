  ...
  <div class="container">
    <!-- <form action="/action_page.php"> -->
      ...
      <div class="row">
        ...
        <div class="col-75">
          <input type="text" id="fb" name="input_fb" placeholder="Your FBaccount.." value="<?php echo isset($signin_user) ? $signin_user["fb_account"] : ''; ?>" required pattern="https://www.facebook.com/.+" title="FacebookのマイページURLを貼り付けてください">
        </div>
      </div>
  </div>
