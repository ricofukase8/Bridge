    ...
    <div class="tab-pane active" role="tabpanel" id="step2">
      <div class="container">
        <!-- <form action="/action_page.php"> -->
          ...
          <div class="row">
            <div class="col-25">
              <label for="job_offer_contents" class="step2_label disabled">求人情報</label>
            </div>
            <div class="col-75">
              <textarea id="job_offer_contents" name="input_job_offer_contents" placeholder="Write job offer contents..." class="step2_form" disabled><?php echo isset($signin_user) ? $signin_user["offer_contents"] : ''; ?></textarea>
            </div>
          </div>
          <div class="row">
            <div class="col-25">
